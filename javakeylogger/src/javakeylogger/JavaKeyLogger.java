...
class LetsCallCouch {
	...
	public LetsCallCouch() {
		dbClient = new CouchDbClient(); 		
	}

	public void dataToCouch (ObjectForCouch data) {
		Response response = dbClient.save(data);
	}
...
class Task extends TimerTask {
	...
	public void run() {
		...
		Process p;
		try {
			p = Runtime.getRuntime().exec("xdotool getwindowfocus getwindowname");
...
public class JavaKeyLogger extends JFrame implements ActionListener, ItemListener, NativeKeyListener, NativeMouseInputListener, NativeMouseWheelListener, WindowListener {
	...
	public JavaKeyLogger() {
		...
		letsCallCouch = new LetsCallCouch();
